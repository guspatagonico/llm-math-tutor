    ...
    <header className="bg-slate-900 border-b border-slate-800/80 sticky top-0 z-30 shadow-subtle backdrop-blur-md transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-700 to-indigo-500 text-white flex items-center justify-center shadow-md shrink-0">
            <GraduationCap className="w-5 h-5" />
          </div>
          <div>
            <h1 className="text-lg md:text-xl font-display font-bold text-slate-200 dark:text-white tracking-tight flex items-center gap-1.5 flex-wrap">
              LLM Math Tutor
